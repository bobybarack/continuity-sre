...
| `extracted/tokens.json` | Design tokens: 15 colors, 2 fonts, 6 headings, 0 CTAs |
...
- **Colors**: #111827 (accent), #F8F9FB (bg-light), #FFFFFF (bg-light), #000000 (bg-dark), #101828 (accent), #F9FAFB (bg-light), #E5E7EB (bg-light), #ECFDF5 (bg-light), #364153 (neutral), #1E2939 (accent)
