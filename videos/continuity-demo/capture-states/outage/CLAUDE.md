# CONTINUITY // Autonomous Stream Incident Commander

Source: https://continuity-sre.pages.dev
...
| `extracted/tokens.json` | Design tokens: 19 colors, 2 fonts, 6 headings, 0 CTAs |
...
- **Colors**: #111827 (accent), #F8F9FB (bg-light), #FFFFFF (bg-light), #000000 (bg-dark), #101828 (accent), #E5E7EB (bg-light), #F9FAFB (bg-light), #ECFDF5 (bg-light), #FEF2F2 (bg-light), #009966 (accent)
- **Fonts**: Geist (100-900 variable), Geist Mono (100-900 variable)
