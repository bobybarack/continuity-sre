...
| `extracted/tokens.json` | Design tokens: 14 colors, 2 fonts, 6 headings, 0 CTAs |
...
- **Colors**: #111827 (accent), #F8F9FB (bg-light), #FFFFFF (bg-light), #000000 (bg-dark), #101828 (accent), #E5E7EB (bg-light), #F9FAFB (bg-light), #ECFDF5 (bg-light), #364153 (neutral), #009966 (accent)
